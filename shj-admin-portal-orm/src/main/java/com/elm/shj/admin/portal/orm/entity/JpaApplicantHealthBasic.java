...
public class JpaApplicantHealthBasic implements Serializable {
    ...
    @OneToMany(cascade = {CascadeType.MERGE, CascadeType.PERSIST}, mappedBy = "applicantHealth", orphanRemoval = true)
    @LazyCollection(LazyCollectionOption.FALSE)
    private List<JpaApplicantHealthDiseaseBasic> diseases;

    @OneToMany(fetch = FetchType.LAZY, cascade = {CascadeType.MERGE, CascadeType.PERSIST}, mappedBy = "applicantHealth", orphanRemoval = true)
    @LazyCollection(LazyCollectionOption.FALSE)
