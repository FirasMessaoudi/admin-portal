...
INSERT INTO shc_portal.shc_company_staff_title_lk (id, code, lang, label)
VALUES (1, 'GROUP_LEADER', 'en', 'Group Leader ');
INSERT INTO shc_portal.shc_company_staff_title_lk (id, code, lang, label)
VALUES (2, 'GROUP_LEADER', 'ar', N'قائد مجموعة');
INSERT INTO shc_portal.shc_company_staff_title_lk (id, code, lang, label)
VALUES (3, 'INSPECTOR', 'en', 'Inspector');
INSERT INTO shc_portal.shc_company_staff_title_lk (id, code, lang, label)
VALUES (4, 'INSPECTOR', 'ar', N'أخصائي جودة');
INSERT INTO shc_portal.shc_company_staff_title_lk (id, code, lang, label)
VALUES (5, 'OTHERS', 'en', 'Others');
INSERT INTO shc_portal.shc_company_staff_title_lk (id, code, lang, label)
VALUES (6, 'OTHERS', 'ar', N'أخرى');
SET
...
SET email = 'aelsayed@elm.sa'
WHERE nin in ('1234567897', '9366014457', '1234567891');
GO



UPDATE shc_portal.shc_company
SET contact_number = '8001111752'
WHERE code = '1_ESTABLISHMENT';
UPDATE shc_portal.shc_company
SET contact_number = '8002450013'
WHERE code = '2_ESTABLISHMENT';
GO