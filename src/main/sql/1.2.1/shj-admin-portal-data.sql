...
UPDATE shc_portal.shc_config SET conf_key = 'huic.sms.api.token' WHERE conf_key = 'sms.api.token';

UPDATE shc_portal.shc_config SET conf_key = 'huic.sms.api.url' WHERE conf_key = 'sms.api.url';
