...
/**
 * Dto class for the applicant info emergency data.
 *
 * @author f.messaoudi
 * @since 1.1.0
 */
@Data
public class ApplicantInfoEmergencyDto implements Serializable {
    private static final long serialVersionUID = -2184100857449252449L;
    private  Long id;
