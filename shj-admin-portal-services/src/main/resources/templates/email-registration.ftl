                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                            ...
                            ">
                              ...
                              ">،عزيزي ${user.firstName}</h2>
                                                <p style="font-size: 14px; margin: 0; color: #707070">مرحبا بك في منصة شعائر. يمكن الدخول على المنصة باستعمال اسم المستخدم <#setting number_format="0" />${user.nin}<#setting number_format="" /> وكلمة المرور المرسلة على جوالك</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
