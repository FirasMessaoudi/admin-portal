...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
    ...
    <tr>
        <td bgcolor="#eaeaea" style="padding: 40px 30px 40px 30px;">
            ...
            <p dir="rtl">تلقينا طلبا لإعادة تعيين كلمة المرور الخاصة بك</p>
            <p dir="rtl"> يمكنك الدخول على المنصة باستخدام اسم المستخدم <#setting number_format="0" />${user.nin}<#setting number_format="" /> وكلمة المرور المؤقتة المرسلة على جوالك.</p>
            </br>
            <p>Dear ${user.firstName},</p>
            <p>You requested a reset password in Shaaer platform.</p>
