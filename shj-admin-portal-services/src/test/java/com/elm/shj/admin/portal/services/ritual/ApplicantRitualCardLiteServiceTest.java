...
public class ApplicantRitualCardLiteServiceTest {
    ...
    public void test_find_applicant_card_details_by_uin_success() {
        ...
        Optional<ApplicantRitualCardLiteDto> applicantRitualLiteDtos = applicantRitualCardLiteService.findCardDetailsByUinAndPackageId(EXIST_USER_UIN, Long.parseLong(EXIST_RITUAL_ID));
    ...
    public void test_find_applicant_card_details_by_uin_not_found() {
        ...
        Optional<ApplicantRitualCardLiteDto> returnedCard = applicantRitualCardLiteService.findCardDetailsByUinAndPackageId(FAKE_USER_UIN, Long.parseLong(EXIST_RITUAL_ID));
