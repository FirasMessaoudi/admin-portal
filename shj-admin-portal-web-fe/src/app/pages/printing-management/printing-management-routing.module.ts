...
const routes: Routes = [
  {
    path: 'print-requests/list',
    component: PrintingRequestListComponent,
    canActivate: [AuthenticationGuard],
  },
  {
    path: 'print-requests/details/:id',
    component: PrintingRequestDetailsComponent,
    canActivate: [AuthenticationGuard],
  },
  {
  ...
  {
    path: 'print-requests/success',
    component: SuccessComponent,
    canActivate: [AuthenticationGuard],
  },
  {
    path: 'staff-print-requests/success',
    component: StaffSuccessComponent,
    canActivate: [AuthenticationGuard],
  },
  {
    path: 'print-requests/update/:id',
    component: PrintingRequestAddUpdateComponent,
    canActivate: [AuthenticationGuard],
  },
  {
    path: 'staff-print-requests/list',
    component: StaffPrintingRequestListComponent,
    canActivate: [AuthenticationGuard],
  },
  {
    path: 'staff-print-requests/details',
    component: StaffPrintingDetailsComponent,
    canActivate: [AuthenticationGuard],
  },
];
