...
import { StaffCardDetailsComponent } from '../card-management/staff-card-details/staff-card-details.component';

@NgModule({
  declarations: [
    PrintingRequestListComponent,
    PrintingRequestDetailsComponent,
    PrintingRequestAddUpdateComponent,
    StaffPrintingRequestListComponent,
    StaffPrintingDetailsComponent,
    StaffCardDetailsComponent,
  ],
  imports: [
    CommonModule,
