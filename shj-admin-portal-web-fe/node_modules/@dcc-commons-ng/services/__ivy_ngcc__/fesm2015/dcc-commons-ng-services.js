...
import * as ɵngcc3 from 'ngx-cookie-service';
...
RouteReusableStrategy.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: RouteReusableStrategy, factory: RouteReusableStrategy.ɵfac });
...
I18nService.ɵfac = function I18nService_Factory(t) { return new (t || I18nService)(ɵngcc0.ɵɵinject(ɵngcc1.TranslateService)); };
I18nService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: I18nService, factory: I18nService.ɵfac });
I18nService.ctorParameters = () => [
    { type: TranslateService }
];
I18nService = __decorate([ __metadata("design:paramtypes", [TranslateService])
], I18nService);
...
ErrorHandlerInterceptor.ɵfac = function ErrorHandlerInterceptor_Factory(t) { return new (t || ErrorHandlerInterceptor)(ɵngcc0.ɵɵinject(ɵngcc2.Router), ɵngcc0.ɵɵinject('environment')); };
ErrorHandlerInterceptor.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ErrorHandlerInterceptor, factory: ErrorHandlerInterceptor.ɵfac });
ErrorHandlerInterceptor.ctorParameters = () => [
    { type: Router },
    { type: undefined, decorators: [{ type: Inject, args: ['environment',] }] }
];
ErrorHandlerInterceptor = __decorate([ __param(1, Inject('environment')),
...
HttpCacheService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: HttpCacheService, factory: HttpCacheService.ɵfac });
HttpCacheService = __decorate([ __metadata("design:paramtypes", [])
], HttpCacheService);
...
CacheInterceptor.ɵfac = function CacheInterceptor_Factory(t) { return new (t || CacheInterceptor)(ɵngcc0.ɵɵinject(HttpCacheService)); };
CacheInterceptor.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: CacheInterceptor, factory: CacheInterceptor.ɵfac });
CacheInterceptor.ctorParameters = () => [
    { type: HttpCacheService }
];
CacheInterceptor = CacheInterceptor_1 = __decorate([ __metadata("design:paramtypes", [HttpCacheService])
], CacheInterceptor);
...
ApiPrefixInterceptor.ɵfac = function ApiPrefixInterceptor_Factory(t) { return new (t || ApiPrefixInterceptor)(ɵngcc0.ɵɵinject('environment')); };
ApiPrefixInterceptor.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ApiPrefixInterceptor, factory: ApiPrefixInterceptor.ɵfac });
ApiPrefixInterceptor.ctorParameters = () => [
    { type: undefined, decorators: [{ type: Inject, args: ['environment',] }] }
];
ApiPrefixInterceptor = __decorate([ __param(0, Inject('environment')),
...
JwtInterceptor.ɵfac = function JwtInterceptor_Factory(t) { return new (t || JwtInterceptor)(ɵngcc0.ɵɵinject(ɵngcc3.CookieService), ɵngcc0.ɵɵinject(ɵngcc2.Router), ɵngcc0.ɵɵinject('environment'), ɵngcc0.ɵɵinject(PUBLIC_URL_PATTERNS, 8), ɵngcc0.ɵɵinject(LOGIN_URL, 8)); };
...
JwtInterceptor = __decorate([ __param(2, Inject('environment')),
...
CsrfInterceptor.ɵfac = function CsrfInterceptor_Factory(t) { return new (t || CsrfInterceptor)(ɵngcc0.ɵɵinject(ɵngcc3.CookieService), ɵngcc0.ɵɵinject(ɵngcc2.Router), ɵngcc0.ɵɵinject(ɵngcc4.HttpXsrfTokenExtractor)); };
CsrfInterceptor.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: CsrfInterceptor, factory: CsrfInterceptor.ɵfac });
CsrfInterceptor.ctorParameters = () => [
    { type: CookieService },
    { type: Router },
    { type: HttpXsrfTokenExtractor }
];
CsrfInterceptor = __decorate([ __metadata("design:paramtypes", [CookieService, Router, HttpXsrfTokenExtractor])
], CsrfInterceptor);
...
MockInterceptor.ɵfac = function MockInterceptor_Factory(t) { return new (t || MockInterceptor)(ɵngcc0.ɵɵinject('environment')); };
MockInterceptor.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MockInterceptor, factory: MockInterceptor.ɵfac });
MockInterceptor.ctorParameters = () => [
    { type: undefined, decorators: [{ type: Inject, args: ['environment',] }] }
];
MockInterceptor = __decorate([ __param(0, Inject('environment')),
    __metadata("design:paramtypes", [Object])
], MockInterceptor);
...
HttpService.ɵfac = function HttpService_Factory(t) { return new (t || HttpService)(ɵngcc0.ɵɵinject(ɵngcc4.HttpHandler), ɵngcc0.ɵɵinject(ɵngcc0.Injector), ɵngcc0.ɵɵinject(HTTP_DYNAMIC_INTERCEPTORS, 8)); };
HttpService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: HttpService, factory: HttpService.ɵfac });
HttpService.ctorParameters = () => [
    { type: HttpHandler },
    { type: Injector },
    { type: Array, decorators: [{ type: Optional }, { type: Inject, args: [HTTP_DYNAMIC_INTERCEPTORS,] }] }
];
HttpService = HttpService_1 = __decorate([ __param(2, Optional()), __param(2, Inject(HTTP_DYNAMIC_INTERCEPTORS)),
...
DccCommonsNgServicesModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: DccCommonsNgServicesModule });
DccCommonsNgServicesModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function DccCommonsNgServicesModule_Factory(t) { return new (t || DccCommonsNgServicesModule)(ɵngcc0.ɵɵinject(DccCommonsNgServicesModule, 12)); }, providers: [
        I18nService,
        HttpCacheService,
        ApiPrefixInterceptor,
        ErrorHandlerInterceptor,
...
DccCommonsNgServicesModule = DccCommonsNgServicesModule_1 = __decorate([ __param(0, Optional()), __param(0, SkipSelf()),
    __metadata("design:paramtypes", [DccCommonsNgServicesModule])
], DccCommonsNgServicesModule);
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(I18nService, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc1.TranslateService }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ErrorHandlerInterceptor, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc2.Router }, { type: undefined, decorators: [{
                type: Inject,
                args: ['environment']
            }] }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(HttpCacheService, [{
        type: Injectable
    }], function () { return []; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CacheInterceptor, [{
        type: Injectable
    }], function () { return [{ type: HttpCacheService }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ApiPrefixInterceptor, [{
        type: Injectable
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(JwtInterceptor, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc3.CookieService }, { type: ɵngcc2.Router }, { type: undefined, decorators: [{
                type: Inject,
                args: ['environment']
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(CsrfInterceptor, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc3.CookieService }, { type: ɵngcc2.Router }, { type: ɵngcc4.HttpXsrfTokenExtractor }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MockInterceptor, [{
        type: Injectable
    }], function () { return [{ type: undefined, decorators: [{
                type: Inject,
                args: ['environment']
            }] }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(HttpService, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc4.HttpHandler }, { type: ɵngcc0.Injector }, { type: Array, decorators: [{
                type: Optional
            }, {
                type: Inject,
                args: [HTTP_DYNAMIC_INTERCEPTORS]
            }] }]; }, null); })();
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DccCommonsNgServicesModule, { imports: function () { return [CommonModule,
        HttpClientModule, ɵngcc1.TranslateModule, RouterModule]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DccCommonsNgServicesModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule,
    ...
    }], function () { return [{ type: DccCommonsNgServicesModule, decorators: [{
                type: Optional
            }, {
                type: SkipSelf
            }] }]; }, null); })();
const ɵRouteReusableStrategy_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(RouteReusableStrategy);
