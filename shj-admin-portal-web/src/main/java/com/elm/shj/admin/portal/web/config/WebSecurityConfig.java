...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] PUBLIC_URLS = {"/api/auth/login", "/api/auth/otp", "/api/users/reset-password", "/api/register", "/api/applicants/verify", "/index.html", "/error", "/api-docs", "/swagger-ui.html", "/swagger-ui/**"};
