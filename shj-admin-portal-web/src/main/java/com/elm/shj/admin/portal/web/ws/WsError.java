...
public class WsError {
    ...
    //TODO: Remove error property and make one property int and refactor in all services where it is used.
    private EWsError error = EWsError.GENERIC;
    private int errorCode = EWsError.GENERIC.getCode();
